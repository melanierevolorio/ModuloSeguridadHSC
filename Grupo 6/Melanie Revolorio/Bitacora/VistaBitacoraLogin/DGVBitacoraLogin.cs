...
namespace VistaBitacoraLogin
{
    public partial class DGVBitacoraLogin : DataGridView
    {
        public DGVBitacoraLogin()
        {
            BitacoraLoginUsuario m = new BitacoraLoginUsuario();
            var list = m.leerBitacoraLogin();
